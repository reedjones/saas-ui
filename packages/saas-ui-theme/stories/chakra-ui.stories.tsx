...
import { baseTheme } from '../src/base'
import { FaGithub } from 'react-icons/fa'

export default {
  title: 'Themes/ChakraUI',
...
export const ChakraUI: Story = () => {
  ...
  return (
    <Box p="20" fontSize="sm" position="relative">
      <Stack
        spacing="4"
      ...
      >
        <Stack spacing="1">
          <Heading>Chakra UI Theme</Heading>
          <Text color="muted" fontSize="lg">
            Default Chakra UI theme for Saas UI
          </Text>
        </Stack>
